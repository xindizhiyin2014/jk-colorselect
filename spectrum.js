...
//            "<div class='sp-dd'>&#9660;</div>",
    ...
    function spectrum(element, o) {
        ...
        function initialize() {
            ...
            // offsetElement.bind("click.spectrum touchstart.spectrum", function (e) {//defalut is show color picker
                // if (!disabled) {
                    toggle();
                // }
        ...
        function updateOriginalInput(fireCallback) {
            ...
            colorOnShow = color;
 JKEventHandler.callNativeFunction('selectColor',{'hexString':displayColor,'alpha':color.alpha},null);
